...
class SenderStartComponent extends Bitrix\Sender\Internals\CommonSenderComponent
{
	...
	protected function initParams()
	{
		...
		;
		$this->arParams['PATH_TO_TELEPHONY'] = $this->arParams['PATH_TO_TELEPHONY']
	...
	protected function getTelephonyTiles(): array
	{
		return [
			[
				'id' => 'telephony',
				'name' => Loc::getMessage('SENDER_START_CREATE_TELEPHONY'),
				'selected' => true,
				'iconClass' => 'ui-icon ui-icon-service-infocall',
				'bgColor' => '#2FC6F6',
				'data' => [
					'url' => $this->arParams['PATH_TO_TELEPHONY'],
					'extension' => null,
				],
			],
		];
	...
	protected function prepareResult()
	{
		...
		$this->arResult['MESSAGES']['TELEPHONY'] = [
			'TILES' => $this->getTelephonyTiles(),
		];
